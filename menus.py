...
def crear_menu():
    ...
    submenu_editar = Menu(menu_principal,tearoff=0)
    submenu_editar.add_command(label="Cambiar letra")
    menu_principal.add_cascade(menu=submenu_editar, label="Editar")
